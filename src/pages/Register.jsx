...
const Register = () => {
    ...
    const handleRegister = async (event) => {
        ...
        if (p !== cp) {
            Swal.fire({
                title: 'Đăng ký thất bại!',
                text: 'Mật khẩu xác nhận không khớp. Vui lòng thử lại.',
                icon: 'error',
                confirmButtonText: 'OK',
            });
            return null;
    ...
    return (
        <>
            <div style={{ padding: '20px', textAlign: 'center' }}>
                ...
                <div style={{ width: '65%', height: '500px', margin: '0 auto', padding: '20px', border: '1px solid #ccc', borderRadius: '8px' }} >
                    <form action="#" method="POST" style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div>
                            <div style={{ marginBottom: '15px' }}>
                                <label htmlFor="confirmPassword" style={{ color: '#87bc9d', fontWeight: 'bold' }}>
                                    Xác nhận mật khẩu
                                </label>
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
